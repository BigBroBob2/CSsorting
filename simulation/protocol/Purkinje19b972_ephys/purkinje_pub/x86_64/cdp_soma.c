...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 531, 5);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 cdp20N_FD2 /home/cbao/Purkinje19b972_ephys/purkinje_pub/cdp_soma.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("cdp20N_FD2", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
  cai = _ion_cai;
 { error =  runge(_ninits, 260, _slist1, _dlist1, _p, &t, dt, state, &_temp1);
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/cbao/Purkinje19b972_ephys/purkinje_pub/cdp_soma.mod";
static const char* nmodl_file_text = 
